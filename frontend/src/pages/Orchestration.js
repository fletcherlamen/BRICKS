          ...
          >
            ...
            {executionResults ? (
              <div className="space-y-6 max-h-screen overflow-y-auto">
                ...
                {executionResults.results?.recommendations && Object.keys(executionResults.results.recommendations).length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-gray-900 mb-3 flex items-center">
                      <CpuChipIcon className="h-4 w-4 mr-2 text-blue-500" />
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <pre className="text-sm text-gray-800 whitespace-pre-wrap">
                        {JSON.stringify(executionResults.results.recommendations, null, 2)}
                      </pre>
                    </div>
                  </div>
                )}

                {/* Key Insights (for backward compatibility) */}
