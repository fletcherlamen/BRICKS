#!/usr/bin/env python3
"""
VPS Database Cleanup Script for Trinity BRICKS (Auto Mode)

This script automatically removes legacy tables from the old BRICK 1 system
...
def main():
    ...
    print("🧹 VPS Database Cleanup for Trinity BRICKS (Auto Mode)")
    print("=" * 60)
    ...
    try:
        ...
        print(f"\n🧹 Starting automatic cleanup of {len(tables_to_remove)} legacy tables...")
        ...
        for table in tables_to_remove:
            ...
            if count > 0:
                ...
                if backup_table:
                    ...
                    print(f"⚠️  Proceeding without backup for {table}")
        ...
        print(f"📦 Created backups: {backup_count} tables")
